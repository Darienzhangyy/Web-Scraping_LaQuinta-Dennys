...
party_distances_summary = distances_by_cluster('party', all=F)
...
if(length(plot_objects)>0) {
  save_ggplot = function(object) {
    ggsave(get(object), filename=paste0(object, '.pdf'), 
...
# Write geochart to disk.
save(file='counts_geochart.RData', geochart)
```
