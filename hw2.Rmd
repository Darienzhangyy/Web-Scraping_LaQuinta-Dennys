...
We also visualize the number of LaQuinta and Denny's in each state and their corresponding distances in each state. http://rpubs.com/Darien/117132 contains Google Geochart visualizations produced via the `googleVis` package.
